...
class ExerciseTest extends TestCase
{
    ...
    public function testGetPrivateExerciseDetailsLoggedInAndWithPermissions()
    {
        ...
        $excepted_array_exercise_tests_received = array(
            array("id"=>"5", "title"=>"sum_correct", "hint"=>"Test1HintExercise3", "test_code"=>"ZnVuY3Rpb24gc3VtX2NvcnJlY3QoKQpsdWF1bml0LmFzc2VydEVxdWFscyhzdW0oMyw0KSAsIDcpCmx1YXVuaXQuYXNzZXJ0RXF1YWxzKHN1bSg0LDMpICwgNykKbHVhdW5pdC5hc3NlcnRFcXVhbHMoc3VtKDMsLTQpICwgLTEpCmVuZA=="),
            array("id"=>"6", "title"=>"sum_correct2", "hint"=>"Test2HintExercise3", "test_code"=>"ZnVuY3Rpb24gc3VtX2NvcnJlY3QyKCkKbHVhdW5pdC5hc3NlcnRFcXVhbHMoc3VtKDMsNCkgLCA3KQpsdWF1bml0LmFzc2VydEVxdWFscyhzdW0oNCwzKSAsIDcpCmx1YXVuaXQuYXNzZXJ0RXF1YWxzKHN1bSgzLC00KSAsIC0xKQplbmQ="));
    ...
    public function testGetPublicExerciseDetails()
    {
        ...
        $this->assertEquals($excepted_array_exercise_details_received, $response_array['exercise']);
        $excepted_array_exercise_tests_received = array(
            array("id"=>"3", "title"=>"sum_failing", "hint"=>"Test1HintExercise2", "test_code"=>"ZnVuY3Rpb24gc3VtX2ZhaWxpbmcoKQpsdWF1bml0LmFzc2VydEVxdWFscyhzdW0oMyw0KSAsIDgpCmx1YXVuaXQuYXNzZXJ0RXF1YWxzKHN1bSg0LDMpICwgOSkKbHVhdW5pdC5hc3NlcnRFcXVhbHMoc3VtKDMsLTQpICwgLTcpCmVuZA=="),
            array("id"=>"4", "title"=>"sum_failing2", "hint"=>"Test2HintExercise2", "test_code"=>"ZnVuY3Rpb24gc3VtX2ZhaWxpbmcyKCkKbHVhdW5pdC5hc3NlcnRFcXVhbHMoc3VtKDMsNCkgLCA4KQpsdWF1bml0LmFzc2VydEVxdWFscyhzdW0oNCwzKSAsIDkpCmx1YXVuaXQuYXNzZXJ0RXF1YWxzKHN1bSgzLC00KSAsIC03KQplbmQ="));
        $this->assertEquals($excepted_array_exercise_tests_received, $response_array['tests']);
    }
    ...
    public function testHandleTestStudentCodeWithPermissionToAccessExerciseTestsAndNoSysntaticErrors()
    {
        ...
        $expected_tests_result = ["sum_correct"=>true, "sum_correct2"=>true];

        //log in with user 1 that has permissions for exercise 3 that is private
        $headers = ['Authorization' => 'Bearer ' . $this->makeLoginForUser('user_already_in_db', 'password_already_in_db')];
        $headers = $this->transformHeadersToServerVars($headers);
        //code = function sum(num1, num2) \n return num1 + num2; \n end
        $response = $this->call("GET", "/api/exercises/" . $exercise_id . "/test", ['code'=>"ZnVuY3Rpb24gc3VtKG51bTEsIG51bTIpIFxuIHJldHVybiBudW0xICsgbnVtMjsgXG4gZW5k"], [], [], $headers); 
        $response->assertStatus(200);
        $response_array = $response->decodeResponseJson();
        echo "\n\n\n\n";
